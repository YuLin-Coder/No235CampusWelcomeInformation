...
<head>
    ...
    <meta name="description" content="学生">
        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header" style="height: 158px;">
                <div class="dropdown profile-element">
                    ...
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">${STUDENT.sname}</strong></span>
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        ...
                        <li>
                            <a href="/ysms/student/loginOut"><b>安全退出</b>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li>
                <a href="#">
                    ...
                    <span class="nav-label">新生报到</span><span class="fa arrow"></span>
                </a>
                <ul class="nav nav-second-level">
                    <li>
                        <a class="J_menuItem" href="view_rule.jsp">查看报道规则</a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="resign.jsp">报道并注册</a>
                    <li>
                         <a class="J_menuItem" href="view_dorm.jsp">查看宿舍分配</a>
                    </li>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a class="J_menuItem" href="changePassword.jsp">修改密码</a>
                    </li>
                </ul>
            </li>
